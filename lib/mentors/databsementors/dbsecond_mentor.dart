...
class DbsecondMentor extends StatefulWidget {
//  const DbsecondMentor({Key? key}) : super(key: key);

  @override
  _DbsecondMentorState createState() => _DbsecondMentorState();
}

class _DbsecondMentorState extends State<DbsecondMentor> {
  launchWhatsApp() async {
    final link = WhatsAppUnilink(
      phoneNumber: '+91-9359644407',
      text: "Hey! I'm inquiring about the Database Course.",
    );
    await launch('$link');
  }
  @override
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Center(
                                          child: CircleAvatar(
                                            radius: 80,
                                            backgroundImage: AssetImage('assets/mentors/priyanka mam.jpg'),
                                        ...
                                        ListTile(
                                          ...
                                          title: Text(
                                            'Priyanka Chaudhari Mam.(SQL Developer)',
                                        ...
                                        ListTile(
                                          ...
                                          title: Text(
                                            '                     Worked At:-                                             '
                                                'Netwin System And Software(I) Pvt. Ltd. and Mswipe Technologies Pvt.Ltd.',
                                        ...
                                        ListTile(
                                          tileColor: Colors.grey[300],
                                          title: Text(
                                            'Technologies:- SQL, PL-SQL, MySQL, Java, C++, C, Python',
                                            style: TextStyle(fontSize: 20,color: Colors.black),
                                          ),
                                        ),
                                        ...
                                        ListTile(
                                          tileColor: Colors.grey[300],
                                          title: Text(
                                            'Tools:- SQL Sever, PL/SQL, Microsoft SQL Server ',
                                            style: TextStyle(fontSize: 20,color: Colors.black),
                                          ),
                                        ),

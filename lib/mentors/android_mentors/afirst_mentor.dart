...
class AfirstMentor extends StatefulWidget {
  //const AfirstMentor({Key? key}) : super(key: key);

  @override
  _AfirstMentorState createState() => _AfirstMentorState();
}

class _AfirstMentorState extends State<AfirstMentor> {
                                         ...
                                         child: Column(
                                           children: [
                                             ...
                                             Center(
                                              child: CircleAvatar(
                                                radius: 80,
                                               backgroundImage: AssetImage('assets/mentors/deva sir.jpg'),
                                             ...
                                             ListTile(
                                               ...
                                               title: Text(
                                                 'Mr. Devendra Dhande Sir.(Android Developer)',

...
class SecondMentor extends StatefulWidget {
  //const SecondMentor({Key? key}) : super(key: key);

  @override
  _SecondMentorState createState() => _SecondMentorState();
}

class _SecondMentorState extends State<SecondMentor> {
  launchWhatsApp() async {
    final link = WhatsAppUnilink(
      phoneNumber: '+91-9359644407',
      text: "Hey! I'm inquiring about the Testing & Database Courses.",
    );
    await launch('$link');
  }
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Center(
                                          child: CircleAvatar(
                                            radius: 80,
                                            backgroundImage: AssetImage('assets/mentors/prashant sir.jpg'),
                                        ...
                                        ListTile(
                                          ...
                                          title: Text(
                                            'Mr. Prashant Bari Sir.(Business Analysts,Database Developer)',
                                        ...
                                        ListTile(
                                          ...
                                          title: Text(
                                            '                     Worked At:-                                             '
                                                'Savitriya Technologies and '
                                                'Virmati Software and Telecommunication.',

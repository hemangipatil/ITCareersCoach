...
import 'package:itcareerscoach/mentors/android_mentors/afirst_mentor.dart';
import 'package:itcareerscoach/mentors/android_mentors/athird_mentor.dart';
import 'package:itcareerscoach/mentors/qamentors/first_mentor.dart';
import 'package:share/share.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:whatsapp_unilink/whatsapp_unilink.dart';
class MobilApplicationsDeveloper extends StatefulWidget {
  @override
  _MobilApplicationsDeveloperState createState() => _MobilApplicationsDeveloperState();
}

class _MobilApplicationsDeveloperState extends State<MobilApplicationsDeveloper> {
  ...
  launchWhatsApp() async {
    final link = WhatsAppUnilink(
      ...
      text: "Hey! I'm inquiring about the Android Mentors.",
    );
    await launch('$link');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Center(child: Text('Android Development')),
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            // ),
                                            child: Image.asset('assets/android1.png', fit: BoxFit.contain,height: 300,width: 500, ),
                                          )
                                        ],
                                      ),
                                    ),
                                      ...
                                      child: Center(
                                        child: Column(
                                          children: [
                                            ...
                                            ListTile(
                                                tileColor: Colors.grey[300],
                                                title: Text('        Android software development is the process by which applications are created for devices running the Android operating system. Google states that[3] "Android apps can be written using Kotlin, Java and recently launched '
                                                  'Flutter which  is an open-source UI software development kit created by Google. It is used to develop cross platform applications for Android, iOS . ',
                                                  ...
                                                  children: [
                                                     Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                            ...
                                                            child: Image.asset('assets/mentors/deva sir.jpg',
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                          ...
                                                          child: Image.asset('assets/mentors/prajakt sir.jpg',
                                                            fit: BoxFit.contain,height: 200,width: 150,),
                                                    ...
                                                    Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                         // color: Colors.black,
                                                          ...
                                                          child: Image.asset('assets/mentors/ashish sir.jpg',
                                                            fit: BoxFit.contain,height: 150,width: 150,),
